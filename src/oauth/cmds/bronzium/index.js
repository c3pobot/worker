...
module.exports = async(obj = {})=>{
  try{
    ...
    let qty = 100, loginConfirm, msg2send = {content: 'You do not have google or fb linked'}, packId, opt = [], identity, pObj, tObj, socialTotal = 0, timeNow = Date.now()
    ...
    if(packId){
      ...
      tObj = await Client.oauth(obj, 'buyItem', dObj, {itemId: packId, paymentCurrency: 4, quantity: qty}, loginConfirm)
