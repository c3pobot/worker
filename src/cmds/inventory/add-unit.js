...
module.exports = async(obj = {}, opt = {})=>{
  ...
  let tempUnit = { baseId: uInfo.baseId, nameKey: uInfo.nameKey, combatType: uInfo.combatType, rarity: 7, gear: {}}
  if(rLevel > 0){
  ...
  return { content: `${uInfo.nameKey} was added to your list of default units for \`/inventory squad\` command...` }
}
