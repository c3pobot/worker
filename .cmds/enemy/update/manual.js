...
const { checkGuildAdmin, getDiscordAC, replyButton, getGuildId, replyTokenError, buttonPick, replyMsg, getOptValue } = require('src/helpers')
...
module.exports = async(obj = {}, opt = [])=>{
  ...
  let enemyId = eObj.guildId, enemyName = eObj?.guildName
