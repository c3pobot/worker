...
module.exports = async(obj = {}, opt = {})=>{
  ...
  if(!tempObj.chId || !tempObj.msg) return { content: 'You must provide a channel and message to set alt greeting' }

  await mongo.set('discordServer', { _id: obj.guild_id }, { welcomeAlt: tempObj })
  return { content: `Alt greeting message was updated for <#${tempObj.chId}> and is **${tempObj.status ? 'enabled':'disabled'}**`}
}
