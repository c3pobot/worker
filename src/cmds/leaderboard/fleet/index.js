...
module.exports = async(obj = {}, opt = {})=>{
  ...
  let lb = await swgohClient.oauth(obj, 'getLeaderboard', dObj, { leaderboardType: 2, combatType: 2 })
  ...
  let embedMsg = { color: 15844367, description: `Fleet Arena Leaderboard (${players.length})`, timestamp: new Date() }
