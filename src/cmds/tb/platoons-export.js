...
const mapPlatoons = (data = {}, platoons = {}, maxRelic = 9)=>{
...
const { getOptValue, getPlayerAC, getGuildId } = require('src/helpers')
module.exports = async(obj = {}, opt = [])=>{
  let msg2send = {content: 'Error getting data'}, excelPlats, excelUnits
  ...
  if(!platObj || platObj?.length === 0) return { content: 'Error mapping platoons'}
  ...
  if(tempExcelPlats) excelPlats = Buffer.from(tempObj, 'binary')
