...
const guildProject = { name: 1, summary: 1, member: 1, profile: 1 }
const playerProject = { gp: 1, gpChar: 1, gpShip: 1, summary: 1 }
module.exports = async(obj = {}, opt)=>{
  try{
    ...
    if(allyCode && !dObj.mentionError){
      ...
      guild = await swgohClient('fetchGuild', { id: +allyCode, excludePlayers: true, guildProject: guildProject, playerProject: playerProject })
    }
    if(guild){
