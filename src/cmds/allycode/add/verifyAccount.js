...
const assetUrl = 'https://game-assets.swgoh.gg'
...
module.exports = async(obj = {}, opt = {}, pObj)=>{
  ...
  let embedMsg = {
    color: 15844367,
    thumbnail:{
      url: `${assetUrl}/${data.icon}.png`
    },
    description: `allyCode **${pObj.allyCode}** for player **${pObj.name}** is already linked to another discordId\n`
  }
  embedMsg.description += `You can verify you have access to this account by setting you profile portrait to **${data.nameKey}** (shown in this message) and running the command again.\n`
